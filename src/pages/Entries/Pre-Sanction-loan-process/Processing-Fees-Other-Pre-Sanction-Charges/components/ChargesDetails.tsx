...
class tableModel {
  ...
  GLCode: string = "";
  chargesToBeCollected: string = "";
  actualChargesCollected: string = "";
  chargesAsParameters: string = "";
}
export const ChargesDetails = () => {
  const [formError, setFormError] = useState<boolean>(false);
  const [formData, setFormData] = useState<chargesDetailsModel>(
    new chargesDetailsModel()
  );
      ...
      <PageBody heading={"Charges Details"}>
        <form action="">
          ...
          >
              ...
              <table class="tbl">
                <thead>
                  <tr>
                    ...
                    <th>GL Code</th>
                    <th>Charges to be collected</th>
                    <th>Actual Charges collected</th>
                    <th>Charges as per Parameter</th>
                    <th></th>
                  </tr>
                </thead>
                <tbody>
                  {formData.tableData.map((data, i) => {
                    return (
                      <tr>
                        ...
                        <td>
                          <input
                            name={"chargesToBeCollected"}
                            value={data.chargesToBeCollected}
                            onInput={(e) => tableInputChangeHandler(e, i)}
                          />
                        </td>
                        <td>
                          <input
                            name={"actualChargesCollected"}
                            value={data.actualChargesCollected}
                            onInput={(e) => tableInputChangeHandler(e, i)}
                          />
                        </td>
                        <td>
                          <input
                            name={"chargesAsParameters"}
                            value={data.chargesAsParameters}
                            onInput={(e) => tableInputChangeHandler(e, i)}
                          />
                        </td>
                        <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        name={"chargesToBeCollected"}
                        value={tableDataNew.chargesToBeCollected}
                        onInput={(e) => tableValuesController(e)}
                      />
                    </td>
                    <td>
                      <input
                        name={"actualChargesCollected"}
                        value={tableDataNew.actualChargesCollected}
                        onInput={(e) => tableValuesController(e)}
                      />
                    </td>
                    <td>
                      <div class="add_button_wrapper">
                        <input
                          name={"chargesAsParameters"}
                          value={tableDataNew.chargesAsParameters}
                          onInput={(e) => tableValuesController(e)}
                        />
                        <button
                          type={"button"}
            ...
            <div className="spacer cs4"></div>
            <h4 className="cs2 dg pic">Total charges :</h4>
            <InputComp
              formValuesController={formValuesController}
              name=""
              value={'0'}
            ...
            <h4 className="cs2 dg pic">
              Total charges on service tax to be collected :
            </h4>
            <InputComp
              formValuesController={formValuesController}
              name=""
              value={'0'}
            />
            <h4 className="cs2 dg pic">Service tax on charges :</h4>
            <InputComp
              formValuesController={formValuesController}
              name=""
              value={'0'}
